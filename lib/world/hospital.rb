module Synthea
  class Hospital < Synthea::Provider
    ...
    def self.load(file)
      ...
      if SyntheaExt::PROVIDERS.count > 0
        SyntheaExt::PROVIDERS.each do |_provider_name, provider_stats|
          provider_stats['properties']['services_provided'] = "emergency inpatient ambulatory"
